#!/usr/bin/env bash
# PT-217: spaces e2e in the native test container (Xvfb + xdotool).
# Run inside the prismattyc-native-tests container after entrypoint has started
# Xvfb, Openbox, and pmux. Host driver: tests/native/docker/run.sh spaces-e2e.
set -euo pipefail
